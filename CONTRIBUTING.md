...
`cxd` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/cxd
[issue tracker]: https://github.com/<USERNAME>/cxd/issues
